...
const ProfileThumbSkeleton = () => {
  return (
    <div className='flex gap-y-4 py-4 pb-10 flex-col'>
      <Skeleton className='rounded-xl w-full h-48 relative'>
        <div className='flex absolute left-0 -bottom-1/4'>
          <Skeleton className='w-24 h-24 rounded-full -z-10' />
        </div>
      </Skeleton>
      <div className='flex max-sm:flex-col justify-between gap-y-1 items-center mt-10'>
